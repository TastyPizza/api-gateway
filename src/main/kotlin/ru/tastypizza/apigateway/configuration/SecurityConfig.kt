...
class SecurityConfig {
    ...
    fun securityWebFilterChain(httpSecurity: ServerHttpSecurity): SecurityWebFilterChain? {
        return httpSecurity
            ...
            .authorizeExchange()
            .pathMatchers("/auth/sign-in", "/auth/sign-up", "/public_key", "/menu/**", "/orders/check-menu-item").permitAll()
            .pathMatchers("/auth/verification").hasAuthority("ROLE_UNVERIFIED_CLIENT")
            .pathMatchers("/profile/**", "/orders/**", "/restaurant/**").hasAuthority("ROLE_VERIFIED_CLIENT")
            .anyExchange()
            .authenticated()
            .and()
